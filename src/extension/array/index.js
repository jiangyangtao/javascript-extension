...
if (!Array.prototype.remove) {
  Array.prototype.remove = function remove(object, thisArg) {
    if (this === undefined || this === null) throw new TypeError();
...
if (!Array.prototype.keySort) {
  Array.prototype.keySort = function keySort(key, order) {
    if (this === undefined || this === null) throw new TypeError();

    let _order = true;
    if (order === 'desc') _order = false;
    return this.sort(win.keySort(key, _order));
  };
}
